...
for item in g_data:
	...
	try:
		...
		print 'Affected platforms: ' + item.contents[1].find_all('p')[1].text+', '+item.contents[1].find_all('p')[2].text
	except:
		pass
	print ''
	...
	try:
		...
		print 'Affected platforms: ' + item.contents[3].find_all('p')[1].text+', '+item.contents[1].find_all('p')[2].text
	except:
		pass
	print ''
	...
	try:
		...
		print 'Affected platforms: ' + item.contents[5].find_all('p')[1].text+', '+item.contents[1].find_all('p')[2].text
	except:
		pass
	print ''
	...
	try:
		...
		print 'Affected platforms: ' + item.contents[7].find_all('p')[1].text+', '+item.contents[1].find_all('p')[2].text
	except:
		pass
	print ''
	...
	try:
		...
		print 'Affected platforms: ' + item.contents[9].find_all('p')[1].text+', '+item.contents[1].find_all('p')[2].text
	except:
		pass